...
png(paste(input,"jak2case",i,".png",sep=""),type="cairo",width=1000)
  plotCN(pos=snpinfo$Position,LRR = sampledata[[i]]$Log.R.Ratio,BAF = sampledata[[i]]$B.Allele.Freq,main = paste("case:sample ",i," on chr9"))
}
